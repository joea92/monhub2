...
export function getCompatLabelColor(label) {
  switch (label) {
    case "Excellent match": return "bg-emerald-100 text-emerald-800 border-emerald-200";
    case "Good match": return "bg-blue-100 text-blue-800 border-blue-200";
    case "Decent match": return "bg-amber-100 text-amber-800 border-amber-200";
    case "Low synergy": return "bg-red-100 text-red-800 border-red-200";
...
export function getHouseLabelColor(label) {
  switch (label) {
    case "Strong synergy": return "bg-emerald-100 text-emerald-800 border-emerald-200";
    case "Mostly compatible": return "bg-blue-100 text-blue-800 border-blue-200";
    case "Mixed compatibility": return "bg-amber-100 text-amber-800 border-amber-200";
    case "Difficult house": return "bg-red-100 text-red-800 border-red-200";
    default: return "bg-gray-100 text-gray-800";
  }
}
