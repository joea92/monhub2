      ...
      <div className="relative overflow-hidden rounded-2xl bg-card border border-border/40 shadow-sm p-5 md:p-12 mb-5 md:mb-8">
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground max-w-lg mb-6">
            Find the best housemates for your Pokémon in Pokopia using their ideal habitats and favourite item types. Optimize houses, plan towns, and maximize compatibility across all 300 Pokémon.
          </p>
