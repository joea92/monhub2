...
export default function PokemonBySpecialty() {
  ...
  const filtered = useMemo(() => {
    if (!specialty) return [];
    return POKEMON_DATA.filter(p => p.specialty.includes(specialty));
  }, [specialty]);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-1">{specialty} Specialty Pokémon</h1>
        <p className="text-sm text-muted-foreground">{filtered.length} Pokémon with this specialty</p>
      </div>
